...
INSERT INTO sessions(id, movie_id, hall_id, time, price) VALUES (default, 2, 2, DATE '2022-12-09', 400);
INSERT INTO users(id, login) VALUES (default, 'iulia');
INSERT INTO messages(id, message, movie_id, user_id) VALUES (default, 'hello, how are you?', 2, 1);